...
| 3 Hopper | `03-hopper.mp4` | v3 `uV9O1eA5RVEYlBYOznRw` | 8 s | HOPPER, ENV1 | v2 (`faIdPHfINxr0uNBtNkJO`, 7 s) rejected: the coin stayed on his hat and a second coin appeared in his hand. v3 prompt: exactly one coin, lands on the hat, he reaches up and takes that same coin off, flicks it, hat empty, leaps. Review PENDING. Rejected versions in `rejected/`. |
