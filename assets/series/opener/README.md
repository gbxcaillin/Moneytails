...
| 3 Hopper | `03-hopper.mp4` | v4 `VLu2Z2eZCTeAN92dIq3c` | 7 s | HOPPER, ENV1 | Pass (v4). One coin lands on his hat at about 3 s and stays there through the cross-eyed look and shrug; he leaps off at 7 s with it still on his head. Nothing in his hands but the guitar. v2 and v3 were rejected for a second coin appearing during a flick; the flick was dropped from the gag. Rejected versions in `rejected/`. |
