...
| 3 Hopper | `03-hopper.mp4` | v2 `faIdPHfINxr0uNBtNkJO` | 7 s | HOPPER, ENV1 | Pass (v2). Strums for two seconds, the coin lands on his hat and rides there while he glances up, a coin is flicked, he springs off the bench right. The coin sits on the hat rather than bouncing off it, which reads as a better gag. v1 (4 s) kept in `rejected/`. |
